...
> Historical log only. This file records earlier implementation iterations and
> can mention obsolete paths or APIs. Current architecture and release guidance
> live in `README.md`, `docs/SCENARIO_COVERAGE.md`, and
> `docs/dev/DEVELOPMENT.md`.
>
> Do not use this file as an implementation contract. In particular, older
> notes below may mention project-local session stores, per-project watchers,
> old GC gaps, or APIs that have since been replaced by the global
> per-session model.
