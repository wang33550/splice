...
Runtime data under `~/.splice/` can contain command arguments, command output,
tool results, and session identifiers. Treat it as sensitive. Do not upload raw
databases or logs to public issues unless they are sanitized.
